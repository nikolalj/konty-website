    ...
    <div class="prose prose-lg max-w-none">
      ...
      <section class="mb-8">
        ...
        <p class="text-gray-700 mb-4">
          Konty ("we," "our," or "us") is committed to protecting your privacy.
          This Privacy Policy explains how we collect, use, disclose, and
          safeguard your information when you use our point-of-sale software and
          services.
        </p>
        <p class="text-gray-700 mb-4">
          By using our Service, you consent to the data practices described in
          this Privacy Policy. If you do not agree with the practices described
          in this policy, please do not use our Service.
        </p>
      </section>
      ...
      <section class="mb-8">
        ...
        <ul class="list-disc pl-6 text-gray-700 mb-4">
          ...
          <li>
            Business data you input into the system (inventory, sales,
            customers)
          </li>
      ...
      <section class="mb-8">
        ...
        <p class="text-gray-700 mb-4">
          ...
          who assist us in operating our Service, such as payment processors,
      ...
      <section class="mb-8">
        ...
        <p class="text-gray-700 mb-4">
          ...
          Service and fulfill the purposes outlined in this Privacy Policy. We
          may also retain information to comply with legal obligations, resolve
        ...
        <ul class="list-disc pl-6 text-gray-700 mb-4">
          ...
          <li>
            Usage data: Typically retained for up to 2 years for analytics
          </li>
      ...
      <section class="mb-8">
        ...
        <p class="text-gray-700 mb-4">
          ...
          experience with our Service. You can control cookie settings through
      ...
      <section class="mb-8">
        ...
        <p class="text-gray-700 mb-4">
          ...
          are in place to protect your information in accordance with applicable
