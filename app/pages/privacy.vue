    ...
    <div class="prose prose-lg max-w-none">
      ...
      <section class="mb-8">
        ...
        <p class="text-gray-700 mb-4">
          Konty ("we," "our," or "us") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our point-of-sale software and services.
        </p>
        <p class="text-gray-700 mb-4">
      ...
      <section class="mb-8">
        ...
        <ul class="list-disc pl-6 text-gray-700 mb-4">
          ...
          <li>Business data you input into the system (inventory, sales, customers)</li>
          <li>Support communications and feedback</li>
          <li>Marketing preferences and communication settings</li>
        </ul>

        <h3 class="text-xl font-semibold text-gray-800 mb-3">Information We Collect Automatically</h3>
        <ul class="list-disc pl-6 text-gray-700 mb-4">
      ...
      <section class="mb-8">
        ...
        <h3 class="text-xl font-semibold text-gray-800 mb-3">Legal Requirements</h3>
        <p class="text-gray-700 mb-4">
        ...
        <h3 class="text-xl font-semibold text-gray-800 mb-3">Business Transfers</h3>
        <p class="text-gray-700 mb-4">
      ...
      <section class="mb-8">
        ...
        <p class="text-gray-700 mb-4">
          We retain your information for as long as necessary to provide our Service and fulfill the purposes outlined in this Privacy Policy. We may also retain information to comply with legal obligations, resolve disputes, and enforce our agreements.
        </p>
        <ul class="list-disc pl-6 text-gray-700 mb-4">
          <li>Account information: Retained while your account is active</li>
          <li>Transaction data: Retained for tax and compliance purposes</li>
          <li>Usage data: Typically retained for up to 2 years for analytics</li>
      ...
      <section class="mb-8">
        ...
        <p class="text-gray-700 mb-4">
          We use cookies and similar tracking technologies to enhance your experience with our Service. You can control cookie settings through your browser preferences.
        </p>
        <ul class="list-disc pl-6 text-gray-700 mb-4">
      ...
      <section class="mb-8">
        ...
        <p class="text-gray-700 mb-4">
          Our Service is not intended for children under the age of 13. We do not knowingly collect personal information from children under 13. If we become aware that we have collected information from a child under 13, we will delete it promptly.
        </p>
      </section>
