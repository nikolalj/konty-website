    ...
    <div class="prose prose-lg max-w-none">
      ...
      <section class="mb-8">
        ...
        <p class="text-gray-700 mb-4">
          By accessing and using Konty's point-of-sale software and services
      ...
      <section class="mb-8">
        ...
        <p class="text-gray-700 mb-4">
          Konty provides cloud-based point-of-sale software solutions for retail
          and hospitality businesses. Our Service includes inventory management,
          sales processing, customer management, and reporting tools accessible
      ...
      <section class="mb-8">
        ...
        <ul class="list-disc pl-6 text-gray-700 mb-4">
          ...
          <li>
            You must not share your account credentials with unauthorized
            persons
          </li>
        </ul>
      </section>
      ...
      <section class="mb-8">
        ...
        <p class="text-gray-700 mb-4">
          ...
          right to modify our pricing with 30 days' notice.
        </p>
        <ul class="list-disc pl-6 text-gray-700 mb-4">
      ...
      <section class="mb-8">
        ...
        <p class="text-gray-700 mb-4">
          We take the privacy and security of your data seriously. Your use of
          the Service is also governed by our Privacy Policy, which is
      ...
      <section class="mb-8">
        ...
        <p class="text-gray-700 mb-4">
          ...
          owned by Konty and are protected by international copyright,
      ...
      <section class="mb-8">
        ...
        <p class="text-gray-700 mb-4">
          ...
          guarantee uninterrupted access to the Service. We may perform
          maintenance that temporarily affects service availability, and we will
      ...
      <section class="mb-8">
        ...
        <p class="text-gray-700 mb-4">
          In no event shall Konty be liable for any indirect, incidental,
