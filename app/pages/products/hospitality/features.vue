<template>
  <div>
    ...
    <LazySharedFAQ category="hospitality-features" hydrate-on-visible />
...
useSchemaOrg([
  schemas.hospitalityFeatures(),
  schemas.faqSchema(useFaqSchema('pages.products.hospitality.features.faq'))
])
</script>
