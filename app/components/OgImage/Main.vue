<template>
  ...
  >
    <div
      v-if="badge"
      style="position: absolute; top: 56px; right: 56px; padding: 6px 16px; background-color: #10B981; color: white; border-radius: 8px; font-weight: 600; font-size: 16px;"
    >
      {{ badge }}
    </div>

    <div style="display: flex; flex-direction: column; flex: 1;">
      <h1 style="font-size: 60px; font-weight: 700; color: #ffffff; line-height: 1.15; margin: 0 0 24px 0; max-width: 900px;">
        {{ title }}
      </h1>

      <p v-if="description" style="font-size: 26px; color: #c4b5d4; line-height: 1.4; margin: 0; max-width: 700px;">
        {{ description }}
      </p>
