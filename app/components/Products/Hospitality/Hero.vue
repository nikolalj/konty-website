<template>
  ...
  <section class="relative isolate">
    ...
    <!-- Contrast overlay -->
    <div class="absolute inset-0 bg-gradient-to-b from-black/35 via-black/20 to-black/40"/>
    ...
    <UContainer class="relative mx-auto flex min-h-[64vh] items-center py-16 md:min-h-[72vh]">
      <div class="max-w-2xl">
        ...
        <h1 class="text-4xl font-extrabold leading-tight tracking-tight text-white md:text-5xl">
          {{ t('pages.products.hospitality.hero.title') }}
        </h1>

        <!-- TODO: refine benefits -->
        <p class="mt-4 text-lg text-white/90 md:text-xl">
          {{ t('pages.products.hospitality.hero.subtitle') }}
        </p>
        ...
        <div class="mt-8 flex flex-col gap-3 sm:flex-row sm:items-center">
          <UButton
            ...
            @click="onPrimaryCta"
          >
            {{ t('pages.products.hospitality.hero.cta') }}
          </UButton>
          <UButton
            size="lg"
            variant="outline"
          ...
          >
            {{ t('pages.products.hospitality.hero.viewPricing') }}
          </UButton>
        </div>

        <p class="mt-3 text-sm text-white/80">
          {{ t('pages.products.hospitality.hero.features') }}
        </p>
      </div>
    </UContainer>
  </section>
