    ...
    <UContainer class="relative z-10 py-16 sm:py-24 lg:py-32">
      <div class="lg:grid lg:grid-cols-2 lg:gap-16 lg:items-center">
        ...
        <UIAppear direction="right" :delay="300">
          <div class="mt-10 lg:mt-0">
            <div class="relative aspect-[4/3] overflow-hidden rounded-2xl bg-gradient-to-br from-primary-100 to-primary-50 dark:from-primary-900 dark:to-primary-950">
              <NuxtImg
                v-if="overview.image"
                :src="overview.image"
                :alt="hero.title"
      ...
      <div class="mt-16 sm:mt-24">
        <UIAppear>
          ...
          <p class="mx-auto mt-4 max-w-2xl text-center text-lg text-gray-600 dark:text-gray-300">
...
const props = defineProps<{
  solution: 'restaurants' | 'barsCafes' | 'fastFood' | 'grocerySupermarkets' | 'clothingBoutiques' | 'convenienceStores' | 'b2b'
}>()
