      ...
      '/**': {
        headers: {
          ...
          'Content-Security-Policy': process.env.NODE_ENV !== 'development'
            ? "default-src 'self' 'unsafe-inline'; connect-src 'self' https://api.github.com https://*.google.com https://*.google-analytics.com https://*.analytics.google.com https://*.googletagmanager.com https://*.googleapis.com https://*.doubleclick.net https://*.g.doubleclick.net https://cloudflareinsights.com https://*.facebook.com https://*.facebook.net https://*.conversionsapigateway.com https://*.a.run.app; img-src 'self' data: https: blob:; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://*.google.com https://*.google-analytics.com https://*.googletagmanager.com https://*.googleapis.com https://*.gstatic.com https://static.cloudflareinsights.com https://connect.facebook.net https://diffuser-cdn.app-us1.com https://prism.app-us1.com https://trackcmp.net; style-src 'self' 'unsafe-inline' https://*.googletagmanager.com https://*.googleapis.com; font-src 'self' data: https://*.gstatic.com https://*.googleapis.com; frame-src 'self' https://*.google.com https://*.googletagmanager.com https://*.doubleclick.net"
            : ''
        }
      },
